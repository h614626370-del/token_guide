...
import { ArrowLeft, BadgeDollarSign, BarChart3, FileText, Home, Images, LayoutDashboard, LogOut, Mail, MessageSquareText, RefreshCcw, Settings } from 'lucide-vue-next'
