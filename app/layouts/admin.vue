...
import { ArrowLeft, BadgeDollarSign, BarChart3, Boxes, FileText, FolderTree, Gamepad2, Gift, Home, Images, LayoutDashboard, List, LogOut, Mail, MessageSquareText, RefreshCcw, Settings, Tags, TestTube2 } from 'lucide-vue-next'
...
const links = [
  ...
  { label: '模型定价', to: '/admin/model-pricing', icon: Tags },
  { label: 'OpenAI 账号测试', to: '/admin/account-tests', icon: TestTube2 },
