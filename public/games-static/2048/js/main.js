...
game.States.main = function() {
  this.create = function() {
    ...
    var startBtn = game.add.text(0, 0, "开始游戏", {
      font: "bold 20px Arial",
      fill: "#FFFFFF",
      backgroundColor: "#308C8C",
      padding: { x: 18, y: 10 },
      align: "center"
    });
    startBtn.anchor.setTo(0.5, 0.5);
    startBtn.x = game.width / 2;
    startBtn.y = (game.height - startBtn.height) / 2 + 125;
    startBtn.inputEnabled = true;
    startBtn.events.onInputDown.add(this.startGame, this);
  };
...
game.States.start = function() {
  this.create = function() {
    ...
    var scoreTitle = game.add.text(0, 5, "得分", titleStyle);
    ...
    var bestTitle = game.add.text(0, 5, "最高分", titleStyle);
  ...
  this.gameOver = function() {
    if(!this.gameOverMask) {
      ...
      var gameOverText = game.add.text(0, 100, "游戏结束", gameOverTextStyle);
      gameOverText.setTextBounds(0, 0, game.width, game.height);
      this.gameOverMask.addChild(gameOverText);
      var gameOverBtn = game.add.text(0, 0, "再来一局", {
      ...
      gameOverBtn.x = game.width / 2;
      gameOverBtn.y = 225;
      gameOverBtn.inputEnabled = true;
      gameOverBtn.events.onInputDown.add(this.tryAgain, this);
