...
import { getCommunityItemBySlug, isCommunityCategory } from '../../domain/community/service'
...
export default defineEventHandler(async (event) => {
  ...
  if (!isCommunityCategory(category) || typeof slug !== 'string' || !/^[a-z0-9]+(?:-[a-z0-9]+)*$/.test(slug)) {
